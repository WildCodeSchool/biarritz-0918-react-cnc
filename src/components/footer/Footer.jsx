                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-md" style={{marginTop:'15px'}}>
                                <ul className="list-unstyled list-inline" style={{display:'flex', justifyContent:'space-evenly'}}>
                                    <li className="list-inline-item">
                                        <a href="#"><FontAwesomeIcon icon={['fab', 'twitter-square']} size="2x" /></a>
                                    </li>
                                    <li className="list-inline-item">
                                        <a href="https://www.facebook.com/clicetcoupe/"><FontAwesomeIcon icon={['fab', 'facebook-square']} size="2x" /></a>
                                    </li>
                                    <li className="list-inline-item">
                                        <a href="https://www.linkedin.com/company/clicetcoupe/"><FontAwesomeIcon icon={['fab', 'linkedin']} size="2x" /></a>
                                    </li>
                                </ul>
                            </div>
                            <div className="col-md-3" style={{marginTop:'15px'}}>
                                ...
                                <p><strong>Email:</strong> contact@clicetcoupe.com</p>
