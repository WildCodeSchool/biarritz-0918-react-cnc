         ...
         axios
            ...
            .then((response) => {
               axios
                  ...
                  .then((response) => {
                     this.setState({ idSalon: response.data.id, nameSalon: response.data.name });
                     axios
                        ...
                        .then((response) => {
                           const stylists = response.data.filter((sytlist) => {
                              return sytlist.salon == '/api/salons/' + this.state.idSalon;
                           });
                           this.setState({ stylists: stylists, isPending: false });
                        })
            ...
            <div className="row">
               <div className="col-lg-6">
                  <div id="agenda">
                     ...
                     <Agenda rdvs={this.state.rdvs} currentStylist={this.state.currentStylist} salon={true} />
                  </div>
               </div>
            </div>
         </ResponsiveLayout>
